...
if((min(sign(c(diag(cor_s4_nh4_obs),diag(cor_s4_nh4no3_obs),diag(cor_s4_no3_obs))),na.rm=T)>0) & (!is.na(min(sign(c(diag(cor_s4_nh4_obs),diag(cor_s4_nh4no3_obs),diag(cor_s4_no3_obs))))))) pars.Z13am<-rbind(pars.Z13am,MCMC$bestpar)
}
...
lfactorf=1000;
ufactorf=1000;
out_dir='.//out_pre//SUSF-60-ZHANG2013am'
...
##pars0 for N15EXP-CBS,zhang2013am
 pars0=c(
   C_NRec_2_NH4 = 0.0491716,
   Vmax_NH4_2_NRec = 0.0006520959,
   Km_NH4_2_NRec = 63.70075,
...
out_dir='.//out//SUSF-60-ZHANG2013am'
...
lfactorf=1000;
ufactorf=1000;
out_dir='.//out_pre//SUSF-90-ZHANG2013am'
...
out_dir='.//out//SUSF-90-ZHANG2013am'

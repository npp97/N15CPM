...
ufactorf=1000;
Lb3<-c('NH4','NO3','Urea')
out_dir=".//out_pre_SUSF-CBS-60A-M14"
...
obs_ao<-read.csv('.//input//nh4no3_cbssuc_stgavg60A.csv')
ini_val<-read.csv('.//input//Ini_value_cbssuc_stgavg60A.csv')
...
rndgrp<-floor(runif(60,-20000,20000))
...
pars0.M14=c(
		C_NRec_2_NH4 = 0.0032,
		C_NH4_2_NRec = 0.00009,
		C_NH4_2_NLab = 0.0085,
		K_NLab_2_NH4 = 0.001572523,
		C_NO3_2_NRec = 0.00000011,
		C_NRec_2_NO3 = 0.003,
		K_NH4ads_2_NH4 = 0.001804257,
		K_NH4_2_NH4ads = 0.001721704,
		C_NO3_2_NH4 = 0.00003459241,
...
pars0.m07s=c(
		...
		K_NH4ads_2_NH4 = 0.001804257,
		K_NH4_2_NH4ads = 0.001721704,
		C_NO3_2_NH4 = 0.0000172,
		K_NH4_2_NO3 = 0.03894824
)

loadcmp("m14s_batch_CS1.Rc")

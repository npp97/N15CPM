...
ufactorf=1000;
Lb3<-c('NH4','NO3','Urea')
out_dir='.//out_pre_SUSF-CBS-60-ZHANG2013amg'
...
out_dir='.//out_SUSF-CBS-60-ZHANG2013amg'
...
rst_11_60f<-getpar_fnal_z13amg(arst=rst_11,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_12_60f<-getpar_fnal_z13amg(arst=rst_12,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_13_60f<-getpar_fnal_z13amg(arst=rst_13,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)

rst_31_60f<-getpar_fnal_z13amg(arst=rst_31,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_32_60f<-getpar_fnal_z13amg(arst=rst_32,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_33_60f<-getpar_fnal_z13amg(arst=rst_33,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)

rst_41_60f<-getpar_fnal_z13amg(arst=rst_41,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_42_60f<-getpar_fnal_z13amg(arst=rst_42,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_43_60f<-getpar_fnal_z13amg(arst=rst_43,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)

rst_51_60f<-getpar_fnal_z13amg(arst=rst_51,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_52_60f<-getpar_fnal_z13amg(arst=rst_52,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_53_60f<-getpar_fnal_z13amg(arst=rst_53,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)

rst_61_60f<-getpar_fnal_z13amg(arst=rst_61,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_62_60f<-getpar_fnal_z13amg(arst=rst_62,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
rst_63_60f<-getpar_fnal_z13amg(arst=rst_63,fntrt_p=3,lib_nm,lfactor=lfactor,ufactor=ufactor,niter_1=niter_1,niter_2=niter_2,burninlength=burninlength)
...
gen_fig_final(rst_11,'SUSF-1-1-60')
gen_fig_final(rst_12,'SUSF-1-2-60')
gen_fig_final(rst_13,'SUSF-1-3-60')

gen_fig_final(rst_31,'SUSF-3-1-60')
gen_fig_final(rst_32,'SUSF-3-2-60')
gen_fig_final(rst_33,'SUSF-3-3-60')

gen_fig_final(rst_41,'SUSF-4-1-60')
gen_fig_final(rst_42,'SUSF-4-2-60')
gen_fig_final(rst_43,'SUSF-4-3-60')

gen_fig_final(rst_51,'SUSF-5-1-60')
gen_fig_final(rst_52,'SUSF-5-2-60')
gen_fig_final(rst_53,'SUSF-5-3-60')

gen_fig_final(rst_61,'SUSF-6-1-60')
gen_fig_final(rst_62,'SUSF-6-2-60')
gen_fig_final(rst_63,'SUSF-6-3-60')
